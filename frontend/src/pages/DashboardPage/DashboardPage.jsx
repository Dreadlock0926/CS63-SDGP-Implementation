...
function DashboardStatistics({voxal,ongoingCourses,completedCourses,hoursLearned}) {
    ...
    return user ? (
        ...
        <div className="dashboard-complete-container">
            ...
            <div className="dashboard-main">
                <DashboardGraph />
                <DashboardStatistics voxal={voxalPoints} ongoingCourses={ongoingCourse}  completedCourses={completeCourse} hoursLearned={hoursLearned} />
                <DashboardCourses />
                <DashboardActivity/>
            </div>
        </div>
