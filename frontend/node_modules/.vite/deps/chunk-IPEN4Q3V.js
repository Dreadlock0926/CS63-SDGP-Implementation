...
var ClassNameConfiguratorContext = React36.createContext(defaultContextValue);
function useClassNamesOverride(generateUtilityClass3) {
  const {
    disableDefaultClasses
  } = React36.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React37.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React37.useEffect(() => {
  ...
  const updateRootElementName = React37.useCallback((instance) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IPEN4Q3V.js.map
